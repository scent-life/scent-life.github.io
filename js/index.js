(function(root) {
    ...
    root.i18n['zh-CN'] = {
        ...
        "SMELL_DESC": "人类的嗅觉在生物学上非常重要, 它可以留在我们记亿，也可成为沟通信号，潜意识里影响人的情绪跟行为。我们并没意识到它的重要，但它却显著的影响着我们生活，在商业上发展上， 也不如视觉、 听觉或触觉在商品化多有满足， 我们的产品“ SCENT” 目的是要填补这块需求的空缺 ",
        "SOLVE_TITLE": "我们要解决的",
